                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <form class="nav-link" action="cuentas">
                                <input type="hidden" name="idUser" value= <%= request.getAttribute("idUser")%>  >
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                <button id="camaleon" type="submit">Cuentas</button>
                            </form>
                                
                            <form class="nav-link" action="historial">
                            <input type="hidden" name="idUser" value= <%= request.getAttribute("idUser")%>  >
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            <button id="camaleon" type="submit">Historial</button>
                            </form>
                        </div>
                    </div>
                </nav>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" > Name:  <%= request.getAttribute("name")%></h1>
                        <h1 class="mt-4" > IdUser: <%= request.getAttribute("idUser")%></h1>
                                    ...
                                    <div class="card-header">
                                        <form id="createAccountForm" action="createAccount" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="double" class="form-control" name="interes" required>
                                            </div>
